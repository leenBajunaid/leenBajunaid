...
class LeenBajunaid:
    def __init__(self):
        self.role      = "Software Developer & Cybersecurity Specialist"
        self.pronouns  = "she/her"
        self.company   = "Building and securing products at a software company"
        self.expertise = ["Full-Stack Development", "ERP Systems",
                          "System Automation", "Cybersecurity", "AI Integration"]
        self.ai        = "Claude (Anthropic) for AI-powered automation"
```

I'm a software developer building production applications, customizing **ERP
systems**, and engineering **automations** that replace slow manual workflows.
Alongside development, I work as a **cybersecurity specialist** — creating
defensive tooling such as firewalls and encryption utilities. I integrate
**AI (Claude / Anthropic)** into products to automate real work: booking
systems, admin dashboards, and internal tools.
